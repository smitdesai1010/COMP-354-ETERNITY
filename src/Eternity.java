	...
	public static void performFunction(int index) throws CustomException
	{
		...
		switch(index) 
		{
			case 1 : {
				...
				System.out.print("Enter x (Value between -1 and 1 inclusive): ");
				double x = keyboard.nextDouble();
				if(x < -1 || x > 1)
					{
						throw new CustomException("Illegal argument! Remember: Value for x must be between 1 and -1 inclusive");
					}
				
				System.out.println(arcCos.acos(x));
				System.out.println("");
				break;
			}
